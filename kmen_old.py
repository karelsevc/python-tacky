...
with open('tackyKmen.csv', 'w', newline='', encoding="utf-8") as csvfile:
...
#                    print('Buňka  obsahuje obrázek')
                    ...
                    print('Buňka  neobsahuje obrázek')
            row_new = f"{row[0]}| {row[1]}| {obrazekC}| {obrazekD}| {obrazekE}| {row[5]}| {row[6]}| {row[7]}| {day}.{month}.{year}"
            row = row_new
